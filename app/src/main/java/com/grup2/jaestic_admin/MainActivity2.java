...
public class MainActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Dish.foods.size()==0 || FoodCategory.categories.size()==0) startActivity(new Intent(getApplicationContext(), MainActivity2.class));
        else {
            ...
            Log.i("DIVAC", "FOODS");
            for (Dish food : Dish.foods) Log.i("DIVACK", food.toString());
