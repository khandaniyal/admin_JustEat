...
public class Dish {
    ...
    public Dish(String name, int price, String description, String imagePath, LinkedList<String> ingredients) {
        this.name = name;
        this.price = price;
    ...
    public Dish(String name, int price, String description, String imagePath) {
        this.name = name;
        this.price = price;
        this.description = description;
        this.imagePath = imagePath;
